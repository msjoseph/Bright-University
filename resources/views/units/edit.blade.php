...
@section('content')
    ...
    <div class="container" style="margin-top: 20px">
        <div class="row ">
            ...
            <div class="col-lg-6 mt-2">
                <h3 class="pull-right" >Modifying {{$unit->name}}</h3>
            </div>
        </div>
        {!! Form::open(['action' => ['UnitsController@update', $unit->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        <div class="form-group">
            {{Form::label('name', 'Name')}}
            {{Form::text('name', $unit->name, ['class' => 'form-control', 'placeholder' =>'Name'])}}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{Form::number('year', $unit->year, ['min' => '1', 'max' => '4', 'class' => 'form-control'])}}
        </div>
        <div class="form-group">
            {{Form::label('semester', 'Semester')}}
            {{Form::number('semester', $unit->semester, ['min' => '1', 'max' => '2', 'class' => 'form-control'])}}
        </div>
